...
if __name__ == '__main__':
    print("CUDA Device Count: ", torch.cuda.device_count())  # CUDA Device Count:  6
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='/my/notebook_work/lcy/code_folder/yolo_v10/runs/train/yolo-v8-urpc2/weight/best.pt', help='trained weights path')
    # parser.add_argument('--weights', type=str, default='yolov8.pt', help='trained weights path')
